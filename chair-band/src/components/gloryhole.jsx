    ...
    <div className={styles.gloryhole_div}>
      <div className={styles.text_div}>
        <p>
          ...
          avpifuipuaf ipiudfg i ipu. Did you hate our last performance? Want to
          know our favourite type of furniture? Are you feeling bored, lonely
          and it’s after 10pm? Let us know what you’re up for.
        </p>
      </div>
      {/* form below */}
